...
<div>
  <Navbar let:hidden let:toggle style="border-bottom: 0.25px solid #ddd;">
    ...
    <NavUl {activeUrl} {hidden}>
      <NavLi href="{base}/">Start</NavLi>
      <NavLi href="{base}/about">Über mich</NavLi>
    </NavUl>
  </Navbar>
    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div class="items-center">
        <div class="flex mt-4 space-x-5 justify-center sm:mt-0">
          <!-- discord --> 
          <a href="https://discord.com/users/390938915579625472" target="_blank" class="text-primary-500 hover:text-primary-700">
            <svg 
              class="w-4 h-4"
              aria-hidden="true"
          ...
          <!-- github -->
          <a href="https://github.com/tfmerk" target="_blank" class="text-primary-500 hover:text-primary-700">
            <svg
              class="w-4 h-4"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
